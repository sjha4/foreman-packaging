...
%{gem_instdir}/spec
%{gem_instdir}/spidr.gemspec

%posttrans
%{foreman_plugin_log}

%changelog
* Tue Jun 18 2024 sajha <sajha> 0.7.1-1
- Add rubygem-spidr generated by gem2rpm using the foreman_plugin template
